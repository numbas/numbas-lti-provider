...
urlpatterns = [
    ...
    path('resource/<int:pk>/analysis', views.resource.AnalysisView.as_view(), name='resource_analysis'),
    path('resource/<int:pk>/analysis/tags', views.resource.AnalysisTagsView.as_view(), name='resource_analysis_tags'),
    ...
    path('resource/<int:pk>/create_lineitem', views.resource.CreateLineitemView.as_view(), name='resource_create_lineitem'),
    path('resource/<int:pk>/unwanted_lineitem', views.resource.UnwantedLineitemView.as_view(), name='resource_unwanted_lineitem'),
