...
urlpatterns = [
    ...
    path('resource/<int:pk>/discount_part', views.resource.DiscountPartView.as_view(), name='discount_part'),
    path('resource/<int:pk>/validate_receipt', views.resource.ValidateReceiptView.as_view(), name='validate_receipt'),
    path('discount_part/<int:pk>/update', views.resource.DiscountPartUpdateView.as_view(), name='discount_part_update'),
    path('discount_part/<int:pk>/delete', views.resource.DiscountPartDeleteView.as_view(), name='discount_part_delete'),
    ...
    path('attempt/<int:pk>/remark_part', views.attempt.RemarkPartView.as_view(), name='remark_part'),
    path('remark_part/<int:pk>/update', views.attempt.RemarkPartUpdateView.as_view(), name='remark_part_update'),
    path('remark_part/<int:pk>/delete', views.attempt.RemarkPartDeleteView.as_view(), name='remark_part_delete'),
